<!-- lang: de · review: translated, light native proofread recommended · target ≤2500 chars · store long description -->

**Sperren Sie eine kleine, wertvolle Datei mit einem Passwort — und bewahren Sie sie dort auf, wo sie wirklich überlebt, oder dort, wo niemand sie findet.**
...
- Den Export Ihres Passwort-Managers sichern und jahrelang aufbewahren, ohne einem Cloud-Anbieter zu vertrauen — und ihn ausdrucken, damit ein defekter Laptop ihn nicht mitnimmt.
- Eine Krypto-Wallet-Wiederherstellungsphrase schützen — winzig, unersetzlich und ohne „Passwort vergessen".
...
- Auf Datenträger als Bilder oder als einzelne .zip speichern, oder als eine undurchsichtige Datei
...
**Bitte beachten**
StegoShard ist für kleine Geheimnisse gedacht, nicht für Backups ganzer Festplatten. Es gibt keine Wiederherstellung, wenn Sie Ihr Passwort verlieren — bewahren Sie es sicher auf. Ein verstecktes Geheimnis bleibt vor einem beiläufigen Blick unauffällig; es ist keine Garantie gegen eine entschlossene forensische Untersuchung. Dies ist Beta-Software.
