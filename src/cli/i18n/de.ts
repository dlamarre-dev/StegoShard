...
export const de: CliCatalog = {
  ...
  errExportNumberWrongCommand:
    '--export-number hat bei {command} keine Wirkung (nur save nummeriert einen Export)',
  errCodecColorPaper:
  ...
  errEstimateGalleryFlags:
    'estimate: --gallery zählt Fotos und nimmt daher weder --paper noch --codec',
  ...
  phaseRender: 'Rendern',
  phaseDerive: 'Schlüssel ableiten',
  phasePrepare: 'Fotos vorbereiten',
  phaseEmbed: 'In Fotos verstecken',
  phaseDeliver: 'Dateien schreiben',
  phaseRead: 'Bilder lesen',
  ...
  outEstimateGallery: '{photos} Foto(s) nötig  (k={k} Daten + m={m} Parität + {decoys} Köder)',
  ...
  helpLocale: 'Sprache des Anleitungsblatts, z. B. fr, ja, ko, zh_TW',
  ...
  helpExportNumber:
    'nummerieren Sie diesen Export selbst; zeigt eine Wiederherstellung eine kleinere Zahl, ist es eine ältere Kopie (nie bei abstreitbarer Ausgabe)',
  ...
  helpMcp:
    'Das Model Context Protocol über stdio bereitstellen, für KI-Agenten (siehe docs/API.md)',
